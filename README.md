...
<p align="center">
  <img src="https://raw.githubusercontent.com/evidentloop/evidentloop/v0.1.0a3/docs/assets/evidentloop-hero-sketch.jpg" width="620" alt="A local Git diff flowing through evidence checks into a report and human decision">
</p>
...
<picture>
  <source media="(prefers-reduced-motion: reduce)" srcset="https://raw.githubusercontent.com/evidentloop/evidentloop/v0.1.0a3/docs/assets/evidentloop-report-loop.png">
  <img alt="A representative EvidentLoop report showing a finding, complete diff, browser-local decision, and comment" src="https://raw.githubusercontent.com/evidentloop/evidentloop/v0.1.0a3/docs/assets/evidentloop-report-loop.gif">
</picture>
...
![EvidentLoop lifecycle from a local diff to a validated report, human decision, and explicit next-diff fix verification](https://raw.githubusercontent.com/evidentloop/evidentloop/v0.1.0a3/docs/assets/evidentloop-lifecycle.svg)
...
References: [Pages](https://evidentloop.github.io/evidentloop/) · [V0 scope](https://github.com/evidentloop/evidentloop/blob/v0.1.0a3/docs/v0-scope.md) · [Data model](https://github.com/evidentloop/evidentloop/blob/v0.1.0a3/docs/data-model.md) · [AI host integration](https://github.com/evidentloop/evidentloop/blob/v0.1.0a3/docs/ai-host-integration.md)

Alpha feedback and bug reports are welcome in [GitHub Issues](https://github.com/evidentloop/evidentloop/issues).

## License

Licensed under the [MIT License](https://github.com/evidentloop/evidentloop/blob/v0.1.0a3/LICENSE).
