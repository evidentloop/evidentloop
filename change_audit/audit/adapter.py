...
from change_audit.review.schema import Finding, ReviewResult, ReviewStatus
from change_audit.validation import SCHEMA_VERSION
    ...
    *,
    ...
    for index, review_finding in enumerate(review_result.findings, start=1):
        ...
        finding_node: dict[str, Any] = {
            ...
            "extensions": {"change_audit": extensions},
        }
    ...
    summary = {
        ...
        "extensions": {"change_audit": {"review_diagnostics": diagnostics}},
    }
    audit = {
